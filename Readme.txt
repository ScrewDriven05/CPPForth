...
self-imposed practice exercise for my DSA course which requires us to do stuff like this.

Final goals with the project will be to create a GUI in either Qt with C++ or Tkinter in Python, and to
create a version that will be ported to an STM32 based standalone device.